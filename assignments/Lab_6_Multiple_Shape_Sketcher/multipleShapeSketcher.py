...
pen_fill_colors = {0: '#fb4934', 1: '#b8bb26', 2: '#fabd2f', 3: '#83a598', 4: '#d3869b', 5: '#8ec07c', 6: '#fe8019', 7: '#cc241d', 8: '#98971a', 9: '#d79921',
                   10: '#458588', 11: '#b16286', 12: '#689d6a', 13: '#d65d0e', 14: '#9d0006', 15: '#79740e', 16: '#b57614', 17: '#076678', 18: '#8f3f71', 19: '#427b58', 20: '#af3a03'}

# define dict of colors to be used as background colors
bg_colors = {0: '#1d2021', 1: '#282828', 2: '#32302f', 3: '#3c3836', 4: '#504945', 5: '#665c54', 6: '#7c6f64',
             7: '#928374', 8: '#f9f5d7', 9: '#fbf1c7', 10: '#f2e5bc', 11: '#ebdbb2', 12: '#d5c4a1', 13: '#bdae93', 14: '#a89984'}
...
def draw_shape():
    ...
    while(shape != 4):
        ...
        # while shape is not equal to 4 makes sure our program promptly exits
        # if 4 is entered. This also redefines our previously defined shape
        # variable so it works inside of the whlie loop as intended
        ...
        if shape == 0:
            ...
            # would like to draw the shape corresponding to the number they
            # chose in the shape input above
            shapeCount = int(screen.numinput(
            "How many shapes would you like to draw on the screen?", prompt=PROMPT4))
            ...
            for x in range(shapeCount):
                ...
                # call the command corresponding to the int stored in shape
                # var by looking up it's index in COMMANDS. Fill in all
